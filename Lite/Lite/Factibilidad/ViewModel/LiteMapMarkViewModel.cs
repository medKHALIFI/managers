...
namespace Lite
{
  public class LiteMapMarkViewModel : ViewModelBase
  {
    ...
    #region Constructor
        public LiteMapMarkViewModel(Messenger messenger=null)
            : base(messenger)
    {
      RegisterToMessenger();
      InteractionMode = new LiteMapMarkInteractionMode(this) { InterruptMode = MapInteractionMode.InterruptModeType.AllowInterrupt };
    }
    #endregion
    ...
    /// </summary>
    private LiteMapMarkInteractionMode InteractionMode { get; set; }
