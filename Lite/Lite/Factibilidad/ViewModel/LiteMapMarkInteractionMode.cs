...
namespace Lite
{
    public class LiteMapMarkInteractionMode : SpatialEye.Framework.Client.MapInteractionMode
    {
        #region Fields
        ...
        public LiteMapMarkViewModel _viewModel;
        /// <summary>
        ...
        /// </summary>
        public LiteMapMarkInteractionMode(LiteMapMarkViewModel viewModel)
        {
        ...
        protected override async void OnMouseLeftButtonUp(MapViewModel sender, MapMouseEventArgs args)
        {
            ...
            if (addCoordinate)
            {
                ...
                _viewModel.Latitud = _strLatitud;
                _viewModel.Longitud = _strLongitud;
