...
namespace Lite
{
  ...
  /// </summary>
  public class LiteMapFreeMeasurer : LiteMapMeasurerBase
  {
    #region Static
    ...
    static LiteMapFreeMeasurer()
    {
      // The styles
      _lineStyle = new SolidColorBrush(Colors.Black);
      _grayLineStyle = new SolidColorBrush(Colors.Gray);
      _segmentAnnotationStyle = new SolidColorBrush(Colors.Black);
      _totalAnnotationStyle = new SolidColorBrush(Colors.Black);
      _areaAnnotationStyle = new SolidColorBrush(Colors.Black);
    }
    #endregion
    ...
    public override String DescriptionResourceKey
    {
      get
      {
        return "MapMeasureFreeModeDescription";
      }
    }
    #endregion
  }
