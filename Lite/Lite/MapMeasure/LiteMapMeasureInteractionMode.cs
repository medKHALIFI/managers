...
namespace Lite
{
  ...
  /// be active.
  /// </summary>
  public class LiteMapMeasureInteractionMode : SpatialEye.Framework.Client.MapInteractionMode
  {
    #region Fields
    /// <summary>
    /// The free measurer
    /// </summary>
    private LiteMapFreeMeasurer _freeMeasurer;
    ...
    private LiteMapMeasurerBase Measurer
    {
      ...
      set
      {
        if (_activeMeasurer != value)
        {
          ...
          // Setup the mode description
          DescriptionResourceKey = (_activeMeasurer != null) ? _activeMeasurer.DescriptionResourceKey : null;
