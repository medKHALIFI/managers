...
namespace Lite
{
    ...
    /// </summary>
    public class LiteMapMeasureISViewModel : ViewModelBase
    {
        ...
        public LiteMapMeasureISViewModel(Messenger messenger = null)
            : base(messenger)
        {
            ...
            InteractionMode = new LiteMapMeasureInteractionModeIS(this) { InterruptMode = MapInteractionMode.InterruptModeType.DoNotInterrupt };
        }
        #endregion
        ...
        /// </summary>
        private LiteMapMeasureInteractionModeIS InteractionMode { get; set; }
