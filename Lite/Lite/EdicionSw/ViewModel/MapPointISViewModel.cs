...
namespace Lite
{
    ...
    /// </summary>
    public class MapPointISViewModel : ViewModelBase
    {
        ...
        public MapPointISViewModel(Messenger messenger = null)
            : base(messenger)
        {
            ...
            InteractionMode = new MapPointInteractionModeIS(this) { InterruptMode = MapInteractionMode.InterruptModeType.DoNotInterrupt };
        }
        #endregion
        ...
        /// </summary>
        private MapPointInteractionModeIS InteractionMode { get; set; }
